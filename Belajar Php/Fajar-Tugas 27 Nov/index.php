<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Responsive clothing ecommerce - Bedimcode</title>
    </head>
    <body>
        <!--==================== HEADER ====================-->
                ...
                <div class="home__container container grid">
                    <div class="home__data">
                        ...
                        <p class="home__desctiption">
                            The new collection of clothing from <br> the best brands this year.
                        </p>
        ...
        <footer class="footer section">
                ...
                <div class="footer__content">
                    <div>
                        ...
                        <ul class="footer__links">
                            ...
                            <li>
                                <a href="#" class="footer__link">Contact info
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="footer__links">
                            ...
                            <li>
                                <a href="#" class="footer__link">Popular news</a>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul class="footer__social">
                            ...
                            <a href="https://api.whatsapp.com/send?phone=51123456789&text=Hello" target="_blank"class="footer__social-link">
            ...
            <div class="footer__info container">
                <span class="footer__copy">
                    &#169; ShopALLT by Fajar Sikumbang. All rigths reserved
                </span>
